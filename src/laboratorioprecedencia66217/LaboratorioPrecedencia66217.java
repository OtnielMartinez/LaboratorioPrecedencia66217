 ...
 */
package laboratorioprecedencia66217;
 ...
 * @author lampi
 */
public class LaboratorioPrecedencia66217 {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("¿Cuál es el valor de x? : "); leer.nextLine();
        System.out.println("El valor de x es : " + x);
        boolean b = (6 * 6 > (5 + 10) + 20);
        System.out.println("b = (6 * 6 > (5 + 10) + 20)2");
        System.out.print("¿Cual es el valor de b? : "); leer.nextLine();
        ...
        System.out.print("¿Qué posición del arreglo se modificó? " + "¿Y con qué valor?"); leer.nextLine();
        ...
        System.out.print("¿Cuál es el valor de b? : "); leer.nextLine();
        System.out.println("El valor de b es : " + b);
